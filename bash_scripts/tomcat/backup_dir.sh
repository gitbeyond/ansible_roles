#!/bin/bash
export PATH=/usr/lib64/qt-3.3/bin:/usr/local/node/bin:/data4/apps/maven/bin:/usr/local/jdk1.8.0_73/bin:/usr/local/jdk1.8.0_73/jre/bin:/usr/local/bin:/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/sbin:/home/yz/bin
